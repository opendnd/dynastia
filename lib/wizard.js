var questions     = require('questions'),
    ...
    saver         = require(path.join(libDir, 'saver')),
...
function wizard (output) {
  ...
  questions.askMany({
    ...
    result.yearFormat  = result.yearFormat.toUpperCase();
    ...
    if (result.yearFormat.length === 0) {
      result.yearFormat = 'BCE/CE';
    }
