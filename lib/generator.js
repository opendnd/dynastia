...
var Generator = {
  ...
  generate: function (options) {
    var rolled = roll.roll('2d20'),
        person, age, death, name, issue, DNA, traits;
    ...
    if (theme === undefined) {
      ...
      theme = Generator.themeName;
    } else {
      Generator.themeName = theme; // set the theme name for the new default
    }
    
    Generator.theme = require(path.join(dataDir, theme + '.json'));
